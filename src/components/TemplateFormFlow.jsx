...
import { validarNombrePlantillas } from '../api/templatesGSApi';
...
const TemplateForm = () => {
  ...
  return (
        ...
        {/* Botones --data-urlencode 'buttons*/}<Box sx={{ width: "100%", marginTop: 2, marginBottom: 2, p: 4, border: "1px solid #ddd", borderRadius: 2 }}>
          ...
          <Stack spacing={2}>
            ...
            >
              ...
              {/* Selector de icono - COMENTADO
    <Select
      value={buttons[0]?.icon || "CALENDAR"}
      sx={{ minWidth: 150 }}
      onChange={(e) => updateButton(0, "icon", e.target.value)}
      label="Icono"
    >
    ...
    */}
              ...
              {/* Icono según el tipo de botón - COMENTADO
    <Box sx={{ display: "flex", alignItems: "center", pt: 2 }}>
      {buttons[0]?.type === "FLOW" && <AccountTreeIcon />}
    </Box>
    */}
            </Box> {/* ← ESTA ES LA LLAVE DE CIERRE DEL BOX PRINCIPAL QUE ESTABA FALTANDO */}
