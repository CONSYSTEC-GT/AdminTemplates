...
import { editTemplateFormSchema } from "../schemas/EditTemplateForm.schema.ts";
...
const EditTemplateForm = () => {
  ...
  const onSubmit = async (formData) => {
    ...
    // ✅ Para catálogo los botones no aplican, usamos false directamente
    ...
    if (isCatalog) {
      ...
      result = await editTemplateGupshup(
        appId,
        authCode,
        templatePayload,
        templateData.id,
    ...
    if (result?.status === "success") {
      ...
      Swal.fire({
        title: isCatalog
          ...
          : isFlowTemplate
            ? 'Error al editar plantilla FLOW'
            : 'Error al editar plantilla',
